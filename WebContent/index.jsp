...
%>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			...
			<select name="searchType" class="form-controll mx-1 mt-2">
...
%>
		<div class="card bg-light mt-3">
			<div class="card-header bg light">
				<div class="row">
					<div class="col-8 text-left" ><%= evaluation.getLectureName() %>&nbsp;
						<small><%= evaluation.getProfesserName() %></small>
					</div>
					<div class="col-4 text-right">종합
						<span style="color: red;"><%= evaluation.getTotalScore() %>
						</span>
					</div>
				</div>
			</div>
			<div class="card-body">
				<h5 class="card-title">
					<%= evaluation.getEvaluationTitle() %>&nbsp;<small>(<%= evaluation.getLectureYear() %>년 <%= evaluation.getSemesterDivide() %>학기)</small>
				</h5>
				...
				<div class="row">
					<div class="col-9 text-left">
						...
						<span style="color: green;">(추천:<%= evaluation.getLikeCount() %>명)</span>
					</div>
...
%>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2019 김효건 All Rights Reserved. </footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
