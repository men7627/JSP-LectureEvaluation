...
public class EvaluationDAO {
	public int write(EvaluationDTO evaluationDTO) {
		...
		try {
			...
			pstmt.setString(3, evaluationDTO.getProfesserName().replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\r\n", "<br>"));
	...
	public ArrayList<EvaluationDTO> getList(String lectureDivide, String searchType, String search, int pageNumber) {
		...
		try {
			...
			while (rs.next()) {
				EvaluationDTO evaluationDTO = new EvaluationDTO(rs.getInt(1), rs.getString(2), rs.getString(3),
